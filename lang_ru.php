...
$LANG_MESS_322 = 'Тэги (через пробел)';
...
$libgennews = '';//'<a href="http://gen.lib.rus.ec/donate/">Library Genesis нуждается в вашей финансовой поддержке для открытия нового зеркала!<br/>Вы можете сделать пожертвование посредством Bitcoin, Visa/MasterCard, PayPal, Яндекс.Денег.</a>';
